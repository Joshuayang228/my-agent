...
> **归档快照**：2026-07 缺口审计及 2026-08-16 复核注记。本文件保留原始信息，不作为当前事实源；当前状态请回到项目活跃文档。
...
- [~] **M2 工具**：✅ 工具描述截断防污染（2026-07-09，bridge.ts MAX_TOOL_DESCRIPTION_LENGTH=2048）、✅ Tool Use Examples（2026-07-09，ToolDefinition.inputExamples + 拼进 description，5 个高频工具已补）；[ ] partitionToolCalls 并发分批、contextModifier 延迟修改、isDestructive/isReadOnly 中间地带建模、Tool Search 懒加载、工具合并、Response Format Enum、Namespacing

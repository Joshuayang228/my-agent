...
## 人读摘要（约 30 秒）
- 2026-09-14 当前主目标纠正：用户重新授权全产品体验正式回流与必要后端补齐，目标进行中。正式设置仍为旧 IA、人物世界仍为四个旧 Tab、记忆紧凑体验仍限 preview；此前右坞五工具的局部验收不代表全产品完成。施工与恢复入口：[全产品回流合同](./requirements/product-experience-production-rollout-v1.md)。下一步优先正式设置、记忆、伙伴与人物世界；逐项生产调用、真实数据、测试和文档全部收口后才结束目标。本条是范围与审计纠正，本次尚未修改正式 UI。

...
- 2026-09-14 全产品回流目标进行中：正式设置已切九区共享导航，并接入共享伙伴设置；相处说明使用独立字段、增量自动保存和失败重试。内容页尚未全部采用 demo，正式仍使用七个旧主题，人物世界 / 记忆 / 模型 / Skills / MCP 等继续逐项验收。不得以导航或右坞局部完成代替全产品回流，恢复入口：[全产品回流合同](./requirements/product-experience-production-rollout-v1.md)。

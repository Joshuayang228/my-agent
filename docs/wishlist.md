...
- WISH-045 S6 人物头部回流缺口：SurfaceBaselinePanel 的 MomentsProfileHero 仍独立于正式 WorldHub，包含写死头像字符、伙伴描述和装饰层；不能原样复制为真实人物事实。需保留获准身份布局、共享呈现并接真实角色字段，复核主题 / 窄屏 / 切角，不把六面组件和导航复用视为整页完成。六标签双定义与足迹图标差异已在本批统一。

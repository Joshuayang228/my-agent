...
test.describe('My Agent UI', () => {
  ...
  test('Playground 设置候选覆盖新的信息架构与隔离交互', async ({ page }) => {
    ...
    await expect(candidate.getByTestId('settings-candidate-skills-list')).toContainText('网页研究助手')
    await expect(candidate.getByTestId('settings-candidate-skills-list')).toContainText('代码审查助手')

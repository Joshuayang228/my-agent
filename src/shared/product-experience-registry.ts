...
export const PRODUCT_EXPERIENCE_ASSETS = [
  ...
  experience({
    ...
    sourcePaths: ['src/components/playground/SurfaceBaselinePanel.tsx', 'src/components/playground/SettingsExperienceCandidate.tsx', 'src/components/SettingsPanel.tsx', 'src/components/settings/PermissionSettingsContent.tsx', 'src/components/PermissionRulesEditor.tsx', 'src/components/settings/SettingsLayout.tsx', 'src/components/settings/ModelRoutingSettings.tsx', 'src/components/MemoryPanel.tsx', 'src/components/memory/MemoryManagementControls.tsx', 'src/components/SkillsPanel.tsx', 'src/components/settings/SkillViews.tsx'],

...
export const PRODUCT_EXPERIENCE_ASSETS = [
  experience({
    ...
    sourcePaths: ['src/App.tsx', 'src/components/shell/PrimarySidebar.tsx', 'src/components/chat/callbacks/GeneratedImageResult.tsx'],
    ...
    usesFoundation: ['state.empty', 'state.toast', 'state.permission-confirm', 'state.error', 'developer.tool-callback', 'behavior.button', 'behavior.icon-button'],
  }),
  experience({

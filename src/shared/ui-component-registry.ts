...
export const UI_COMPONENT_ASSETS = [
  ...
  component({ key: 'layout.foundation-workbench', layer: 'experience', labelZh: '基础组件工作台', labelEn: 'Foundation Workbench', descriptionZh: '集中展示可复用基础组件与隔离故事。', category: 'layout', status: 'playground', implementation: 'custom', sourcePath: 'src/components/playground/FoundationComponentsPanel.tsx', stories: ['按钮', '输入', '标签切换', '下拉选择', '可搜索选择', '表单字段', '复选框', '开关', '对话框', '弹出层', '下拉菜单', '命令面板', '右键菜单', '提示浮层', '空态', '确认框', '错误与反馈', '提示条', '加载指示器', '骨架屏', '进度条', '工具卡', 'Markdown 渲染', '资产目录', '文件树', '差异查看器', '滚动区域', '分栏拖拽'], accessibilityNotes: ['故事筛选状态可读', '基础层边界说明可见', '不把业务文案伪装成基础组件'] }),

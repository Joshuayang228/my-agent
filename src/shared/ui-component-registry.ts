...
export const UI_COMPONENT_ASSETS = [
  ...
  component({ key: 'state.confirm-panel', labelZh: '应用内确认面板', labelEn: 'Confirm Panel', descriptionZh: '用于删除、覆盖和强制操作的主题内确认面板。', category: 'state', status: 'adopted', implementation: 'custom', sourcePath: 'src/components/foundation/ConfirmPanel.tsx', stories: ['危险操作确认', '处理中', '取消'], accessibilityNotes: ['使用 alertdialog 语义', '确认与取消操作名称清楚', '处理中不改变操作槽尺寸'] }),

...
export const UI_COMPONENT_ASSETS = [
  ...
  component({ key: 'behavior.tabs', labelZh: '标签切换', labelEn: 'Tabs', descriptionZh: '同一任务域内切换互斥内容。', category: 'behavior', status: 'playground', implementation: 'custom', sourcePath: 'src/components/playground/UiControlsPanel.tsx', reference: 'Playground 场景控制器使用 PlaygroundLayout.tsx 与 src/components/playground/state-switchers.css；产品内容标签独立展示。', stories: ['Playground 子分类', 'Debug 分组导航'], accessibilityNotes: ['选中态可被读屏识别', '键盘左右切换', '不把页面级导航伪装成 Tabs'] }),

...
export const UI_COMPONENT_ASSETS = [
  ...
  component({ key: 'behavior.tabs', labelZh: '标签切换', labelEn: 'Tabs', descriptionZh: '同一任务域内切换互斥内容。', category: 'behavior', status: 'playground', implementation: 'custom', sourcePath: 'src/components/playground/catalog.ts', stories: ['Playground 子分类', 'Debug 分组导航'], accessibilityNotes: ['选中态可被读屏识别', '键盘左右切换', '不把页面级导航伪装成 Tabs'] }),
  ...
  // 伙伴世界。
  component({ key: 'companion.status-bar', labelZh: '伙伴状态条', labelEn: 'Companion Status Bar', descriptionZh: '显示当前伙伴身份和人物世界入口。', category: 'companion', status: 'adopted', implementation: 'custom', sourcePath: 'src/components/CompanionStatusBar.tsx', stories: ['默认态', '超长角色名'], accessibilityNotes: ['角色名称完整可读', '生活入口有明确按钮名', '长名称不挤压操作'] }),
  component({ key: 'companion.memory-citations', labelZh: '记忆引用芯片', labelEn: 'Memory Citation Chips', descriptionZh: '展示回复使用的记忆证据。', category: 'companion', status: 'adopted', implementation: 'custom', sourcePath: 'src/components/chat/MemoryCitationChips.tsx', stories: ['多条引用', '敏感引用'], accessibilityNotes: ['引用来源可解释', '敏感标记不只靠颜色', '芯片可键盘聚焦'] }),
  component({ key: 'companion.moment-card', labelZh: '生活事件卡', labelEn: 'Moment Card', descriptionZh: '朋友圈时间线中的生活事件截面。', category: 'companion', status: 'adopted', implementation: 'custom', sourcePath: 'src/components/MomentsPanel.tsx', stories: ['普通事件', '长文事件'], accessibilityNotes: ['时间和正文顺序可读', '图片有替代文本', '不伪造可交互入口'] }),
  component({ key: 'companion.role-card', labelZh: '角色卡', labelEn: 'Role Card', descriptionZh: '角色架中的身份、状态和切换入口。', category: 'companion', status: 'adopted', implementation: 'custom', sourcePath: 'src/components/CharacterShelfPanel.tsx', stories: ['活跃角色', '非活跃角色'], accessibilityNotes: ['活跃状态可读', '切换动作说明后果', '会话中不可切换时给出原因'] }),

  // 布局导航。
  component({ key: 'layout.primary-sidebar', labelZh: '主侧栏', labelEn: 'Primary Sidebar', descriptionZh: '会话、人物世界和开发入口的一级导航。', category: 'layout', status: 'adopted', implementation: 'custom', sourcePath: 'src/components/shell/PrimarySidebar.tsx', stories: ['展开态', '折叠态'], accessibilityNotes: ['导航区域有名称', '折叠后保留可发现入口', '键盘顺序符合视觉顺序'] }),
  ...
  component({ key: 'layout.foundation-workbench', layer: 'experience', labelZh: '基础组件工作台', labelEn: 'Foundation Workbench', descriptionZh: '集中展示可复用基础组件与隔离故事。', category: 'layout', status: 'playground', implementation: 'custom', sourcePath: 'src/components/playground/FoundationComponentsPanel.tsx', stories: ['按钮', '输入', '工具卡', '记忆芯片'], accessibilityNotes: ['故事筛选状态可读', '基础层边界说明可见', '不把业务文案伪装成基础组件'] }),

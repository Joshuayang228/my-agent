...
export const UI_COMPONENT_ASSETS = [
  ...
  component({ key: 'layout.world-details-panel', layer: 'experience', labelZh: '人物世界生活面详情', labelEn: 'World Details Panel', descriptionZh: '以真实伙伴状态、生活动态和资产组合文化角、家居与足迹只读视图。', category: 'companion', status: 'adopted', implementation: 'custom', sourcePath: 'src/components/WorldDetailsPanel.tsx', stories: ['文化角', '家居', '足迹', '加载与错误重试'], accessibilityNotes: ['内容来自真实 companion IPC', '派生视图不提供虚假编辑', '加载失败可重试'] }),

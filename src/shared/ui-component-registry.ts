...
export const UI_COMPONENT_ASSETS = [
  ...
  component({ key: 'layout.world-details-panel', layer: 'experience', labelZh: '人物世界生活面详情', labelEn: 'World Details Panel', descriptionZh: '读取真实角色资产与生活动态；家居和足迹通过 WorldLivingContent 与 Playground 共享展示，不复制生活样张。', category: 'companion', status: 'adopted', implementation: 'custom', sourcePath: 'src/components/WorldDetailsPanel.tsx', stories: ['文化角', '家居', '足迹', '加载与错误重试'], accessibilityNotes: ['内容来自真实 companion IPC', '只读页面不提供虚假编辑', '刷新失败保留内容且可重试', '不同主角响应不混合', '固定尺寸刷新操作槽'] }),

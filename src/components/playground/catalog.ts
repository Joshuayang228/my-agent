...
export const PLAYGROUND_TABS: readonly PlaygroundTabDef[] = [
  { id: 'design-tokens', label: '设计语言', group: 'foundation', description: '颜色、主题、圆角与动效，先建立可复用的视觉语言。' },
  { id: 'visual-assets', label: '图标与视觉', group: 'foundation', description: '统一查看可复用图标和视觉资产，确认名称、尺寸与采用证据。' },
  { id: 'foundation-components', label: '基础组件', group: 'foundation', description: '先验收可复用基础能力，再让产品体验引用。' },
  ...
  { id: 'chat-lab', label: '对话试验', group: 'agent-experiments', description: '隔离测试对话输入、上下文和回复行为。' },
  { id: 'model-test', label: '模型能力', group: 'agent-experiments', description: '隔离检查模型连接、能力探测和辅助调用。' },
  { id: 'tools', label: '工具手测', group: 'agent-experiments', description: '隔离检查工具参数、权限边界和执行反馈。' },

...
export const ASSET_GOVERNANCE = [
  ...
  },
  {
    ...
    sourcePaths: ['src/shared/product-experience-registry.ts', 'src/assets/playground', 'src/components/playground/SettingsExperienceCandidate.tsx'], registryPaths: ['src/shared/product-experience-registry.ts'], discovery: '显式体验依赖注册表',
